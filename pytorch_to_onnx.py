...
def gpt2_test():
    for model_class, tokenizer_class, pretrained_weights, save_name in MODELS:
        ...
        input_ids_1 = tokenizer.encode("Here is some text to encode Hello World", add_special_tokens=True, return_tensors='pt')
        with torch.no_grad():
        ...
        input_ids_2 = tokenizer.encode("Here is some alternative text to encode I love Seattle", add_special_tokens=True, return_tensors='pt')
